  ...
  return (
    <div className="flex flex-col min-h-screen">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-4">
                  <h1 className="font-headline text-4xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                    Navigate Your Future at College
                  </h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Campus Navigator helps you find the perfect department by providing in-depth information, career pathways, and personalized AI-driven recommendations.
                  </p>
                </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground">&copy; 2024 Campus Navigator. All rights reserved.</p>
